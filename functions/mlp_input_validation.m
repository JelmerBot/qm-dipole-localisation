function mlp_input_validation(input_id)
%mlp_input_validation
%
%   Syntax mlp_input_validation(input_id)
%
...
output_file_results = ['./config/validation/mlp_input_mode_' num2str(input_id) '.mat'];
output_file_configuration = ['./config/parameters/mlp_input_mode_' num2str(input_id) '.mat'];
output_file_plot = ['./images/validation/mlp_input_mode_' num2str(input_id) '_'];
