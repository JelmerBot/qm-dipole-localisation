function plot_predicted_locations(predictions, sources, params)
%plot_predicted_locations
%
% Syntax: plot_predicted_locations(predictions, sources, params)
%
