classdef my_FullyConnected < nnet.internal.cnn.layer.Layer
    ...
    properties (Dependent)
        ...
        % WeightsInitializer   Initializes the weights
        WeightsInitializer 
    ...
    methods
        function this = my_FullyConnected(name, inputSize, numNeurons)
            this.Name = name;
            ...
            % This is overridden by the external layer
            this.WeightsInitializer = @(n, m) zeros(m, n);
        ...
        function this = initializeLearnableParameters(this, precision)
            ...
            if isempty(this.Weights.Value)
                ...
                weights = this.Initializer(this.InputSize, this.NumNeurons);
        ...
        function initializer = get.WeightsInitializer(this)
            initializer = this.Initializer;
        end
        
        function this = set.WeightsInitializer(this, initializer)
