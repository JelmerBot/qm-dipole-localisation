function layer = my_meanSquaredErrorLayer( varargin )
    % my_meanSquaredErrorLayerLayer   Regression output layer for a neural network
    %
    %   layer = my_meanSquaredErrorLayerLayer() creates a regression output layer for
    %   a neural network. The regression output layer holds the name of the
    %   loss function that is used for training the network.
    %
    %   layer = my_meanSquaredErrorLayerLayer('PARAM1', VAL1) specifies optional
    ...
    %
    %       layer = my_meanSquaredErrorLayerLayer();
    %
    ...
    internalLayer = my_MeanSquaredError( args.Name);
