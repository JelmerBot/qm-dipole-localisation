classdef my_MeanSquaredError < nnet.internal.cnn.layer.RegressionLayer
    % my_MeanSquaredError   my_MeanSquaredError loss output layer
    ...
    methods
        function this = my_MeanSquaredError(name)
            % my_MeanSquaredError   Constructor for the layer
            this.Name = name;
            this.ResponseNames = {};
    ...
    methods (Static)
        function layer = constructWithObservationDim( name, responseNames, observationDim )
            ...
            layer = nnet.internal.cnn.layer.my_MeanSquaredError( name );
