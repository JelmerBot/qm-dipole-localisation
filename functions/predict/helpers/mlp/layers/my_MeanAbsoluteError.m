classdef my_MeanAbsoluteError < nnet.internal.cnn.layer.RegressionLayer
    % my_MeanAbsoluteError   my_MeanAbsoluteError loss output layer
    ...
    methods
        function this = my_MeanAbsoluteError(name)
            % my_MeanAbsoluteError   Constructor for the layer
            this.Name = name;
            this.ResponseNames = {};
    ...
    methods (Static)
        function layer = constructWithObservationDim( name, responseNames, observationDim )
            ...
            layer = nnet.internal.cnn.layer.my_MeanAbsoluteError( name );
