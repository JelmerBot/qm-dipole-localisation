function layer = my_meanAbsoluteErrorLayer( varargin )
    % my_meanAbsoluteErrorLayer   Regression output layer for a neural network
    %
    %   layer = my_meanAbsoluteErrorLayer() creates a regression output layer for
    %   a neural network. The regression output layer holds the name of the
    %   loss function that is used for training the network.
    %
    %   layer = my_meanAbsoluteErrorLayer('PARAM1', VAL1) specifies optional
    ...
    %
    %       layer = my_meanAbsoluteErrorLayer();
    %
    ...
    internalLayer = my_MeanAbsoluteError( ...
        args.Name);
