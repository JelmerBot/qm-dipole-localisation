function layers = configure_mlp_dCaAp(n_inputs, n_outputs, params)
%configure_mlp_dCaAp
%
% Syntax: layers = configure_mlp_dCaAp(n_inputs, n_outputs, params)
%
% Hacky copy of configure_mlp, uses dCaAp activation instead of ReLu
narginchk(3, 3)
nargoutchk(1, 1)
